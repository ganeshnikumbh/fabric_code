...
('Salesforce', 'api', 'lh_landing', 'salesforce', 'campaign', 'lh_bronze', 'bronze_salesforce', 'campaign_base', 'lh_silver', 'silver_s1', 'campaign', 'full', NULL, NULL, NULL, NULL, 0, 1, 'elic', 'records', 'q=SELECT+Id,Name,Type,Status,IsActive,StartDate,EndDate,Description,OwnerId,ParentId,Parent.Name,BudgetedCost,ActualCost,ExpectedRevenue,ExpectedResponse,NumberSent,NumberOfLeads,NumberOfConvertedLeads,NumberOfContacts,NumberOfResponses,NumberOfWon,NumberOfOpportunities,AmountAllOpportunities,AmountWonOpportunities,HierarchyBudgetedCost,HierarchyActualCost,HierarchyExpectedRevenue,HierarchyExpectedResponse,HierarchyNumberSent,HierarchyNumberOfLeads,HierarchyNumberOfConvertedLeads,HierarchyNumberOfContacts,HierarchyNumberOfResponses,HierarchyNumberOfWon,HierarchyNumberOfOpportunities,HierarchyAmountAllOpportunities,HierarchyAmountWonOpportunities,TotalEmailsSent,TotalEmailsDelivered,TotalEmailsBounced,TotalEmailsOpened,TotalEmailsClicked,UniqueEmailsOpened,UniqueEmailsClicked,UniqueEmailsBounced,HierarchyTotalEmailsSent,HierarchyTotalEmailsDelivered,HierarchyTotalEmailsBounced,HierarchyTotalEmailsOpened,HierarchyTotalEmailsClicked,HierarchyUniqueEmailsOpened,HierarchyUniqueEmailsClicked,HierarchyUniqueEmailsBounced,IsDeleted,LastActivityDate,LastViewedDate,LastReferencedDate,CreatedById,CreatedDate,LastModifiedById,LastModifiedDate+FROM+Campaign'),
