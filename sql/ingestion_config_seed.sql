...
INSERT INTO dbo.ingestion_config
    (source_name, source_type,
     ...
     silver_lakehouse, silver_schema, silver_table,
     load_type, watermark_column, watermark_type, batch_size, partition_by_column_names,
     is_scd2, active_flag, src_busn_asst, source_path, extraction_query)
VALUES
('Salesforce', 'api', 'lh_landing', 'salesforce', 'account',  'lh_bronze', 'bronze_salesforce', 'account_base',  'lh_silver', 'silver_s1', 'account',  'full', NULL, NULL, NULL, NULL, 0, 1, 'elic', 'records', 'q=SELECT+Id,Name+FROM+Account'),
('Salesforce', 'api', 'lh_landing', 'salesforce', 'campaign', 'lh_bronze', 'bronze_salesforce', 'campaign_base', 'lh_silver', 'silver_s1', 'campaign', 'full', NULL, NULL, NULL, NULL, 0, 1, 'elic', 'records', 'q=SELECT+Id,Name,Type,Status,StartDate,EndDate,IsActive,Description,OwnerId,ParentId,Parent.Name,RecordTypeId,CampaignMemberRecordTypeId,CreatedById,LastModifiedById,ActualCost,BudgetedCost,ExpectedResponse,ExpectedRevenue,AmountAllOpportunities,AmountWonOpportunities,NumberOfContacts,NumberOfConvertedLeads,NumberOfLeads,NumberOfOpportunities,NumberOfResponses,NumberOfWonOpportunities,NumberSent,LastActivityDate,LastViewedDate,LastReferencedDate,CreatedDate,LastModifiedDate,HierarchyActualCost,HierarchyBudgetedCost,HierarchyExpectedRevenue,HierarchyAmountAllOpportunities,HierarchyAmountWonOpportunities,HierarchyNumberOfContacts,HierarchyNumberOfConvertedLeads,HierarchyNumberOfLeads,HierarchyNumberOfOpportunities,HierarchyNumberOfResponses,HierarchyNumberOfWonOpportunities,HierarchyNumberSent,Booth_Needed__c,Company_Write_Up_Bio__c,End_Date_Time_Text__c,End_Date_Time__c,Event_Visit_Review__c,Expected_Attendance__c,Primary_Host__c,Hotel_Name_Address__c,IMO_Agent__c,Line_of_Business__c,Materials_Needed__c,Primary_Contact__c,Promotional_Items__c,Raffle__c,Speaking_Event__c,Sponsorship_Amount__c,Start_Date_Time_Text__c,Start_Date_Time__c,Transportation__c,Video_Needed__c,W9_Needed__c,Sponsorship_Note__c,Actual_Attendees__c,Registered_Attendees__c,Review_Notes_Population_Date__c,Total_Campaign_Members__c,of_Contacts__c,of_IMO_Agents__c,Actual_Response__c,EquiTrust_Platform__c,Calls_Answered__c,Calls_Made__c,Webinar_Recorded__c,Secondary_Host__c,Topic__c,Campaign_Quarter__c,Product__c,Talking_Points__c,Voicemail_Script__c,Total_Remaining__c+FROM+Campaign'),
('Salesforce', 'api', 'lh_landing', 'salesforce', 'contact',  'lh_bronze', 'bronze_salesforce', 'contact_base',  'lh_silver', 'silver_s1', 'contact',  'full', NULL, NULL, NULL, NULL, 0, 1, 'elic', 'records', 'q=SELECT+Id,FirstName,LastName,Salutation,AccountId,ReportsToId,OwnerId,Email,Phone,MobilePhone,HomePhone,OtherPhone,Fax,Title,Department,Birthdate,LeadSource,Description,AssistantName,AssistantPhone,HasOptedOutOfEmail,IsEmailBounced,EmailBouncedDate,EmailBouncedReason,MailingStreet,MailingCity,MailingState,MailingPostalCode,MailingCountry,OtherStreet,OtherCity,OtherState,OtherPostalCode,OtherCountry,MasterRecordId,LastActivityDate,LastViewedDate,LastReferencedDate,IsDeleted,CreatedById,CreatedDate,LastModifiedById,LastModifiedDate,Nickname__c,Agent_Type_Other__c,Licensed_del__c,Agent_Type__c,Marketing_Business_Model_Other__c,Marketing_Business_Model__c,Email_Integrated__c,IMO_Agent_Type__c,Favorite_Activity_del__c,Goals_del__c,Hobbies_del__c,Do_Not_Email_per_Upline__c,Insurance_Specialization_del__c,Sync_with_Salesforce__c,Licensed_Date_del__c,IMO_Agent_Vendor_Status__c,Number_of_Children_del__c,Other_Personal_Information_del__c,Producer_Agent_Status_del__c,Role__c,Social_Security_del__c,States_Certified_del__c,Supress_HubSpot_Integration__c,Spouse_SO_s_name_del__c,Years_Licensed_del__c,Years_with_Agency_del__c,Agent_ID__c,Do_Not_Mail__c,Alternate_Name__c,SalesVue__Salesvue_Add_To_Plan_Ids__c,SalesVue__Salesvue_Plan_Status__c,SalesVue__Salesvue_Remove_From_Plan_Ids__c,SalesVue__Time_Zone_Lookup__c,SalesVue__Time_Zone__c,Do_Not_Email_FOR__c,Do_Not_Email_per_Related_Account__c+FROM+Contact'),
