...
INSERT INTO dbo.ingestion_config
    (source_id, source_name, source_type, source_schema, entity_name, target_lakehouse, target_schema, target_table, load_type, watermark_column, watermark_type, batch_size, active_flag)
VALUES
-- ── Reference / lookup tables (full load) ─────────────────────────────────
(1,  'EQ_Warehouse', 'sqlserver', 'dbo', 'Date',                         'lh_bronze', 'bronze_eqwarehouse', 'date_base',                              'full',        NULL,               NULL,       NULL,   1),
(2,  'EQ_Warehouse', 'sqlserver', 'dbo', 'State',                        'lh_bronze', 'bronze_eqwarehouse', 'state_base',                             'full',        NULL,               NULL,       NULL,   1),
(3,  'EQ_Warehouse', 'sqlserver', 'dbo', 'Company',                      'lh_bronze', 'bronze_eqwarehouse', 'company_base',                           'full',        NULL,               NULL,       NULL,   1),
(4,  'EQ_Warehouse', 'sqlserver', 'dbo', 'ActivityType',                 'lh_bronze', 'bronze_eqwarehouse', 'activity_type_base',                     'full',        NULL,               NULL,       NULL,   1),
(5,  'EQ_Warehouse', 'sqlserver', 'dbo', 'CommissionLevelRank',          'lh_bronze', 'bronze_eqwarehouse', 'commission_level_rank_base',             'full',        NULL,               NULL,       NULL,   1),
(6,  'EQ_Warehouse', 'sqlserver', 'dbo', 'InvestmentDetail',             'lh_bronze', 'bronze_eqwarehouse', 'investment_detail_base',                 'full',        NULL,               NULL,       NULL,   1),
(7,  'EQ_Warehouse', 'sqlserver', 'dbo', 'AccountingAccount',            'lh_bronze', 'bronze_eqwarehouse', 'accounting_account_base',                'full',        NULL,               NULL,       NULL,   1),
(8,  'EQ_Warehouse', 'sqlserver', 'dbo', 'ProductVariationDetail',       'lh_bronze', 'bronze_eqwarehouse', 'product_variation_detail_base',          'full',        NULL,               NULL,       NULL,   1),
(9,  'EQ_Warehouse', 'sqlserver', 'dbo', 'AccountingReporting_Group',    'lh_bronze', 'bronze_eqwarehouse', 'accounting_reporting_group_base',        'full',        NULL,               NULL,       NULL,   1),
(10, 'EQ_Warehouse', 'sqlserver', 'dbo', 'TrainingCourse',               'lh_bronze', 'bronze_eqwarehouse', 'training_course_base',                   'full',        NULL,               NULL,       NULL,   1),
-- ── Core entities ──────────────────────────────────────────────────────────
(11, 'EQ_Warehouse', 'sqlserver', 'dbo', 'Product',                      'lh_bronze', 'bronze_eqwarehouse', 'product_base',                           'full',        NULL,               NULL,       NULL,   1),
(12, 'EQ_Warehouse', 'sqlserver', 'dbo', 'Surrender',                    'lh_bronze', 'bronze_eqwarehouse', 'surrender_base',                         'full',        NULL,               NULL,       NULL,   1),
(13, 'EQ_Warehouse', 'sqlserver', 'dbo', 'Territory',                    'lh_bronze', 'bronze_eqwarehouse', 'territory_base',                         'full',        NULL,               NULL,       NULL,   1),
(14, 'EQ_Warehouse', 'sqlserver', 'dbo', 'Client',                       'lh_bronze', 'bronze_eqwarehouse', 'client_base',                            'incremental', 'StartDate',        'datetime', 50000,  1),
(15, 'EQ_Warehouse', 'sqlserver', 'dbo', 'Agent',                        'lh_bronze', 'bronze_eqwarehouse', 'agent_base',                             'incremental', 'StartDate',        'datetime', 50000,  1),
(16, 'EQ_Warehouse', 'sqlserver', 'dbo', 'Investment',                   'lh_bronze', 'bronze_eqwarehouse', 'investment_base',                        'full',        NULL,               NULL,       NULL,   1),
(17, 'EQ_Warehouse', 'sqlserver', 'dbo', 'ProductStateApproval',         'lh_bronze', 'bronze_eqwarehouse', 'product_state_approval_base',            'full',        NULL,               NULL,       NULL,   1),
(18, 'EQ_Warehouse', 'sqlserver', 'dbo', 'ProductStateVariation',        'lh_bronze', 'bronze_eqwarehouse', 'product_state_variation_base',           'full',        NULL,               NULL,       NULL,   1),
(19, 'EQ_Warehouse', 'sqlserver', 'dbo', 'ProductStateApprovalDisclosure','lh_bronze','bronze_eqwarehouse', 'product_state_approval_disclosure_base', 'full',        NULL,               NULL,       NULL,   1),
...
(30, 'EQ_Warehouse', 'sqlserver', 'dbo', 'Hierarchy_Bridge',             'lh_bronze', 'bronze_eqwarehouse', 'hierarchy_bridge_base',                  'incremental', 'StartDate',        'datetime', 50000,  1),
(31, 'EQ_Warehouse', 'sqlserver', 'dbo', 'Hierarchy_Option',             'lh_bronze', 'bronze_eqwarehouse', 'hierarchy_option_base',                  'full',        NULL,               NULL,       NULL,   1),
(32, 'EQ_Warehouse', 'sqlserver', 'dbo', 'AccountValue',                 'lh_bronze', 'bronze_eqwarehouse', 'account_value_base',                     'incremental', 'StartDate',        'datetime', 50000,  1),
(33, 'EQ_Warehouse', 'sqlserver', 'dbo', 'ExternalAccount_Group',        'lh_bronze', 'bronze_eqwarehouse', 'external_account_group_base',            'incremental', 'StartDate',        'datetime', 50000,  1),
(34, 'EQ_Warehouse', 'sqlserver', 'dbo', 'AdditionalClient_Group',       'lh_bronze', 'bronze_eqwarehouse', 'additional_client_group_base',           'incremental', 'StartDate',        'datetime', 50000,  1),
(35, 'EQ_Warehouse', 'sqlserver', 'dbo', 'AdditionalInfo_Group',         'lh_bronze', 'bronze_eqwarehouse', 'additional_info_group_base',             'incremental', 'StartDate',        'datetime', 50000,  1),
(36, 'EQ_Warehouse', 'sqlserver', 'dbo', 'Reinsurance_Group',            'lh_bronze', 'bronze_eqwarehouse', 'reinsurance_group_base',                 'incremental', 'StartDate',        'datetime', 50000,  1),
-- ── Transaction / event tables ─────────────────────────────────────────────
(37, 'EQ_Warehouse', 'sqlserver', 'dbo', 'Activity',                     'lh_bronze', 'bronze_eqwarehouse', 'activity_base',                          'incremental', 'ProcessDateFK',    'integer',  100000, 1),
(38, 'EQ_Warehouse', 'sqlserver', 'dbo', 'ActivityFinancial',            'lh_bronze', 'bronze_eqwarehouse', 'activity_financial_base',                'incremental', 'ProcessDateFK',    'integer',  100000, 1),
...
(50, 'EQ_Warehouse', 'sqlserver', 'dbo', 'hedge.Options',                'lh_bronze', 'bronze_eqwarehouse', 'hedge_options_base',                     'incremental', 'OptionDate',       'datetime', 50000,  1),
-- ── Remaining groups + views ───────────────────────────────────────────────
(51, 'EQ_Warehouse', 'sqlserver', 'dbo', 'Rider_Group',                  'lh_bronze', 'bronze_eqwarehouse', 'rider_group_base',                       'incremental', 'StartDate',        'datetime', 50000,  1),
(52, 'EQ_Warehouse', 'sqlserver', 'dbo', 'Requirement_Group',            'lh_bronze', 'bronze_eqwarehouse', 'requirement_group_base',                 'incremental', 'StartDate',        'datetime', 50000,  1),
