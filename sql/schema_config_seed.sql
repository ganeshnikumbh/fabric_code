...
-- [W01] aar  9 data fields + 4 context
INSERT INTO schema_config
...
VALUES
  ...
  ('Webex', 'aar', 'aar_base', 'channelInfo',          'channel_info_json',  'STRING',  4, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'siteId',               'site_id',            'STRING',  5, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'siteName',             'site_name',          'STRING',  6, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'teamId',               'team_id',            'STRING',  7, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'teamName',             'team_name',          'STRING',  8, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'userLoginId',          'user_login_id',      'STRING',  9, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', '__top__.start_date',   'start_date',         'STRING', 10, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', '__top__.end_date',     'end_date',           'STRING', 11, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', '__top__.record_type',  'record_type',        'STRING', 12, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', '__top__.source',       'source',             'STRING', 13, 0, 0, 1, GETUTCDATE());

-- [W02] asr  21 data fields + 4 context
INSERT INTO schema_config
    (source_name, source_table_name, target_table_name, source_column_name, target_column_name,
     target_data_type, ordinal_position, include_in_md5hash, is_primary_key, is_active, created_at)
VALUES
  ...
  ('Webex', 'asr', 'asr_base', 'agentSkills',           'agent_skills_json',         'STRING',  5, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo',           'channel_info_json',         'STRING',  6, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'endTime',               'end_time',                  'BIGINT',  7, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'isActive',              'is_active',                 'BOOLEAN', 8, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'multiMediaProfileType', 'multi_media_profile_type',  'STRING',  9, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'orgId',                 'org_id',                    'STRING', 10, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'orgName',               'org_name',                  'STRING', 11, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'parentOrgId',           'parent_org_id',             'STRING', 12, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'parentOrgName',         'parent_org_name',           'STRING', 13, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'siteId',                'site_id',                   'STRING', 14, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'siteName',              'site_name',                 'STRING', 15, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'skillsProfile',         'skills_profile',            'STRING', 16, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'startTime',             'start_time',                'BIGINT', 17, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'state',                 'state',                     'STRING', 18, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'teamId',                'team_id',                   'STRING', 19, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'teamName',              'team_name',                 'STRING', 20, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'userLoginId',           'user_login_id',             'STRING', 21, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', '__top__.start_date',    'start_date',                'STRING', 22, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', '__top__.end_date',      'end_date',                  'STRING', 23, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', '__top__.record_type',   'record_type',               'STRING', 24, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', '__top__.source',        'source',                    'STRING', 25, 0, 0, 1, GETUTCDATE());

-- [W03] clr  103 data fields + 4 context
INSERT INTO schema_config
    (source_name, source_table_name, target_table_name, source_column_name, target_column_name,
     target_data_type, ordinal_position, include_in_md5hash, is_primary_key, is_active, created_at)
VALUES
  ('Webex', 'clr', 'clr_base', 'abandonedSlCount',               'abandoned_sl_count',                 'STRING',   1, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'abandonedType',                  'abandoned_type',                     'STRING',   2, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'agentToDnTransferCount',         'agent_to_dn_transfer_count',         'INT',      3, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'agentTransferedInCount',         'agent_transfered_in_count',          'INT',      4, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'blindTransferCount',             'blind_transfer_count',               'INT',      5, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'blindTransferToAgentCount',      'blind_transfer_to_agent_count',      'INT',      6, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'callLegType',                    'call_leg_type',                      'STRING',   7, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'callRejectedCount',              'call_rejected_count',                'INT',      8, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'callType',                       'call_type',                          'STRING',   9, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'channelSubType',                 'channel_sub_type',                   'STRING',  10, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'channelType',                    'channel_type',                       'STRING',  11, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'childContactId',                 'child_contact_id',                   'STRING',  12, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'childContactType',               'child_contact_type',                 'STRING',  13, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'conferenceConnectedCount',       'conference_connected_count',         'STRING',  14, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'conferenceDuration',             'conference_duration',                'INT',     15, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'conferenceSuccessCount',         'conference_success_count',           'INT',     16, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'connectErrorCount',              'connect_error_count',                'INT',     17, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'connectedCount',                 'connected_count',                    'INT',     18, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'connectedDuration',              'connected_duration',                 'INT',     19, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultDuration',                'consult_duration',                   'INT',     20, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultEpId',                    'consult_ep_id',                      'STRING',  21, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultEpName',                  'consult_ep_name',                    'STRING',  22, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultSuccessCount',            'consult_success_count',              'INT',     23, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToAgentErrorCount',       'consult_to_agent_error_count',       'INT',     24, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToDnErrorCount',          'consult_to_dn_error_count',          'INT',     25, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToEPCount',               'consult_to_ep_count',                'INT',     26, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToEPDuration',            'consult_to_ep_duration',             'INT',     27, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToEpErrorCount',          'consult_to_ep_error_count',          'INT',     28, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToQueueCount',            'consult_to_queue_count',             'INT',     29, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToQueueDuration',         'consult_to_queue_duration',          'INT',     30, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToQueueErrorCount',       'consult_to_queue_error_count',       'INT',     31, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToQueueHandledCount',     'consult_to_queue_handled_count',     'INT',     32, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'contactState',                   'contact_state',                      'STRING',  33, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'createdTime',                    'created_time',                       'BIGINT',  34, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'customer',                       'customer_json',                      'STRING',  35, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'destination',                    'destination',                        'STRING',  36, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'direction',                      'direction',                          'STRING',  37, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'endedTime',                      'ended_time',                         'BIGINT',  38, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'entryPoint',                     'entry_point_json',                   'STRING',  39, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'handleTime',                     'handle_time',                        'INT',     40, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'handleType',                     'handle_type',                        'STRING',  41, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'holdCount',                      'hold_count',                         'INT',     42, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'holdDuration',                   'hold_duration',                      'INT',     43, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'id',                             'id',                                 'STRING',  44, 1, 1, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'interQueueBlindTransferCount',   'inter_queue_blind_transfer_count',   'INT',     45, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'interQueueConsultTransferCount', 'inter_queue_consult_transfer_count', 'INT',     46, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'isActive',                       'is_active',                          'BOOLEAN', 47, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'isHandledByPreferredAgent',      'is_handled_by_preferred_agent',      'BOOLEAN', 48, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'isOptOutOfQueue',                'is_opt_out_of_queue',                'BOOLEAN', 49, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'isOutdial',                      'is_outdial',                         'BOOLEAN', 50, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'isTaskLegHandled',               'is_task_leg_handled',                'BOOLEAN', 51, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'isWithinServiceLevel',           'is_within_service_level',            'BOOLEAN', 52, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'ivrScriptId',                    'ivr_script_id',                      'STRING',  53, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'ivrScriptName',                  'ivr_script_name',                    'STRING',  54, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'ivrScriptTagId',                 'ivr_script_tag_id',                  'STRING',  55, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'ivrScriptTagName',               'ivr_script_tag_name',                'STRING',  56, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'lastActivityTime',               'last_activity_time',                 'BIGINT',  57, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'lastWrapupCodeName',             'last_wrapup_code_name',              'STRING',  58, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'manualAssignCount',              'manual_assign_count',                'INT',     59, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'matchedSkills',                  'matched_skills',                     'STRING',  60, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'matchedSkillsProfile',           'matched_skills_profile',             'STRING',  61, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'nextDestination',                'next_destination_json',              'STRING',  62, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'optOutOfQueueTimestamp',         'opt_out_of_queue_timestamp',         'BIGINT',  63, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'origin',                         'origin',                             'STRING',  64, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConferenceCount',         'outdial_conference_count',           'INT',     65, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConferenceDuration',      'outdial_conference_duration',        'INT',     66, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultCount',            'outdial_consult_count',              'INT',     67, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultDuration',         'outdial_consult_duration',           'INT',     68, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultToEPCount',        'outdial_consult_to_ep_count',        'INT',     69, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultToEPDuration',     'outdial_consult_to_ep_duration',     'INT',     70, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultToQueueCount',     'outdial_consult_to_queue_count',     'INT',     71, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultToQueueDuration',  'outdial_consult_to_queue_duration',  'INT',     72, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultToQueueErrorCount','outdial_consult_to_queue_error_count','INT',    73, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultToQueueHandledCount','outdial_consult_to_queue_handled_count','INT', 74, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'owner',                          'owner_json',                         'STRING',  75, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'postCallConnectedCount',         'post_call_connected_count',          'STRING',  76, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'postCallConsultDuration',        'post_call_consult_duration',         'INT',     77, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'postCallDuration',               'post_call_duration',                 'INT',     78, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'preferredAgentName',             'preferred_agent_name',               'STRING',  79, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'preferredAgentSystemId',         'preferred_agent_system_id',          'STRING',  80, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'queue',                          'queue_json',                         'STRING',  81, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'queueCount',                     'queue_count',                        'INT',     82, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'queuedTo',                       'queued_to',                          'STRING',  83, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'requiredSkills',                 'required_skills',                    'STRING',  84, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'ringingDuration',                'ringing_duration',                   'INT',     85, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'ronaCount',                      'rona_count',                         'INT',     86, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'routingType',                    'routing_type',                       'STRING',  87, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'selfserviceCount',               'selfservice_count',                  'INT',     88, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'selfserviceDuration',            'selfservice_duration',               'INT',     89, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'site',                           'site_json',                          'STRING',  90, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'skillsAssignedIn',               'skills_assigned_in',                 'STRING',  91, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'slaValue',                       'sla_value',                          'STRING',  92, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'status',                         'status',                             'STRING',  93, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'taskId',                         'task_id',                            'STRING',  94, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'taskLegCount',                   'task_leg_count',                     'INT',     95, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'team',                           'team_json',                          'STRING',  96, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'terminatingEnd',                 'terminating_end',                    'STRING',  97, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'terminationReason',              'termination_reason',                 'STRING',  98, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'transferCount',                  'transfer_count',                     'INT',     99, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'transferEpDN',                   'transfer_ep_dn',                     'STRING', 100, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'transferErrorCount',             'transfer_error_count',               'INT',    101, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'transferOutCount',               'transfer_out_count',                 'INT',    102, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'wrapupDuration',                 'wrapup_duration',                    'INT',    103, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', '__top__.start_date',             'start_date',                         'STRING', 104, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', '__top__.end_date',               'end_date',                           'STRING', 105, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', '__top__.record_type',            'record_type',                        'STRING', 106, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', '__top__.source',                 'source',                             'STRING', 107, 0, 0, 1, GETUTCDATE());
...
INSERT INTO schema_config
    (source_name, source_table_name, target_table_name, source_column_name, target_column_name,
     target_data_type, ordinal_position, include_in_md5hash, is_primary_key, is_active, created_at)
VALUES
  ('Webex', 'car', 'car_base', 'activities',            'activities_json',       'STRING',   1, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'channelSubType',        'channel_sub_type',      'STRING',   2, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'channelType',           'channel_type',          'STRING',   3, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'destination',           'destination',           'STRING',   4, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'emailBccList',          'email_bcc_list',        'STRING',   5, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'emailCcList',           'email_cc_list',         'STRING',   6, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'emailReplyTo',          'email_reply_to',        'STRING',   7, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'emailToList',           'email_to_list',         'STRING',   8, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'id',                    'id',                    'STRING',   9, 1, 1, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'isEmailSent',           'is_email_sent',         'BOOLEAN', 10, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'isOutdial',             'is_outdial',            'BOOLEAN', 11, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'matchedSkillsProfile',  'matched_skills_profile','STRING',  12, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'origin',                'origin',                'STRING',  13, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'preferredAgentName',    'preferred_agent_name',  'STRING',  14, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'routingType',           'routing_type',          'STRING',  15, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', '__top__.start_date',    'start_date',            'STRING',  16, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', '__top__.end_date',      'end_date',              'STRING',  17, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', '__top__.record_type',   'record_type',           'STRING',  18, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', '__top__.source',        'source',                'STRING',  19, 0, 0, 1, GETUTCDATE());

-- [W05] csr  176 data fields + 4 context  [part 1 of 2: rows 2165-2254]
INSERT INTO schema_config
    (source_name, source_table_name, target_table_name, source_column_name, target_column_name,
     target_data_type, ordinal_position, include_in_md5hash, is_primary_key, is_active, created_at)
VALUES
  ('Webex', 'csr', 'csr_base', 'abandonedSlCount',                  'abandoned_sl_count',                 'INT',      1, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'abandonedType',                     'abandoned_type',                     'STRING',   2, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'agentHangupCount',                  'agent_hangup_count',                 'INT',      3, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'agentToAgentTransferCount',         'agent_to_agent_transfer_count',      'STRING',   4, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'agentToDnTransferCount',            'agent_to_dn_transfer_count',         'INT',      5, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'agentToEntrypointTransferCount',    'agent_to_entrypoint_transfer_count', 'INT',      6, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'agentToQueueTransferCount',         'agent_to_queue_transfer_count',      'INT',      7, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'agentTransferedInCount',            'agent_transfered_in_count',          'INT',      8, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'autoCsat',                          'auto_csat',                          'STRING',   9, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'bargedInCount',                     'barged_in_count',                    'INT',     10, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'bargedInDuration',                  'barged_in_duration',                 'INT',     11, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'bargedInFailedCount',               'barged_in_failed_count',             'INT',     12, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'blindTransferCount',                'blind_transfer_count',               'INT',     13, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'botName',                           'bot_name',                           'STRING',  14, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'callCompletedCount',                'call_completed_count',               'INT',     15, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'callbackData',                      'callback_data_json',                 'STRING',  16, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'campaignId',                        'campaign_id',                        'STRING',  17, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'campaignName',                      'campaign_name',                      'STRING',  18, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'campaignStatus',                    'campaign_status',                    'STRING',  19, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'captureRequested',                  'capture_requested',                  'BOOLEAN', 20, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'chainedInToEPCount',                'chained_in_to_ep_count',             'INT',     21, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'chainedInToQueueCount',             'chained_in_to_queue_count',          'INT',     22, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'channelMetaData',                   'channel_meta_data_json',             'STRING',  23, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'channelSubType',                    'channel_sub_type',                   'STRING',  24, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'channelType',                       'channel_type',                       'STRING',  25, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'chatType',                          'chat_type',                          'STRING',  26, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'conferenceCount',                   'conference_count',                   'INT',     27, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'conferenceDuration',                'conference_duration',                'INT',     28, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'connectedCount',                    'connected_count',                    'INT',     29, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'connectedDuration',                 'connected_duration',                 'INT',     30, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'consultCount',                      'consult_count',                      'INT',     31, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'consultDuration',                   'consult_duration',                   'INT',     32, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'consultToEPCount',                  'consult_to_ep_count',                'INT',     33, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'consultToEPDuration',               'consult_to_ep_duration',             'INT',     34, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'consultToQueueCount',               'consult_to_queue_count',             'INT',     35, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'consultToQueueDuration',            'consult_to_queue_duration',          'INT',     36, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'contactDriver',                     'contact_driver',                     'STRING',  37, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'contactHandleType',                 'contact_handle_type',                'STRING',  38, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'contactPriority',                   'contact_priority',                   'INT',     39, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'contactReason',                     'contact_reason',                     'STRING',  40, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'cpaStatus',                         'cpa_status',                         'STRING',  41, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'createdTime',                       'created_time',                       'BIGINT',  42, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'crossTalkCount',                    'cross_talk_count',                   'INT',     43, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'crossTalkTime',                     'cross_talk_time',                    'INT',     44, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'csatScore',                         'csat_score',                         'INT',     45, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'customer',                          'customer_json',                      'STRING',  46, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'customerSentimentScore',            'customer_sentiment_score',           'STRING',  47, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'deadAirCount',                      'dead_air_count',                     'INT',     48, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'deadAirTime',                       'dead_air_time',                      'INT',     49, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'destination',                       'destination',                        'STRING',  50, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'direction',                         'direction',                          'STRING',  51, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailBccList',                      'email_bcc_list',                     'STRING',  52, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailBody',                         'email_body',                         'STRING',  53, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailCcList',                       'email_cc_list',                      'STRING',  54, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailContent',                      'email_content',                      'STRING',  55, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailContentType',                  'email_content_type',                 'STRING',  56, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailDate',                         'email_date',                         'INT',     57, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailFullMessage',                  'email_full_message',                 'STRING',  58, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailHasAttachments',               'email_has_attachments',              'BOOLEAN', 59, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailMessageId',                    'email_message_id',                   'STRING',  60, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailRef',                          'email_ref',                          'STRING',  61, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailReplyBody',                    'email_reply_body',                   'STRING',  62, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailReplyContentType',             'email_reply_content_type',           'STRING',  63, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailReplyTo',                      'email_reply_to',                     'STRING',  64, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailToList',                       'email_to_list',                      'STRING',  65, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'endedTime',                         'ended_time',                         'BIGINT',  66, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'epTransferToEPCount',               'ep_transfer_to_ep_count',            'INT',     67, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'evalScore',                         'eval_score',                         'STRING',  68, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'evalScoreType',                     'eval_score_type',                    'STRING',  69, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'evalSectionsFailureCount',          'eval_sections_failure_count',        'INT',     70, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'evalStatus',                        'eval_status',                        'STRING',  71, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'feedback',                          'feedback_json',                      'STRING',  72, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'firstQueueId',                      'first_queue_id',                     'STRING',  73, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'firstQueueName',                    'first_queue_name',                   'STRING',  74, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'flowActivityName',                  'flow_activity_name',                 'STRING',  75, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'flowActivitySequence',              'flow_activity_sequence',             'STRING',  76, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'fullMonitoringCount',               'full_monitoring_count',              'INT',     77, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'globalVariables',                   'global_variables_json',              'STRING',  78, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'holdCount',                         'hold_count',                         'INT',     79, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'holdDuration',                      'hold_duration',                      'INT',     80, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'id',                                'id',                                 'STRING',  81, 1, 1, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isActive',                          'is_active',                          'BOOLEAN', 82, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isBarged',                          'is_barged',                          'BOOLEAN', 83, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isCallback',                        'is_callback',                        'BOOLEAN', 84, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isCampaign',                        'is_campaign',                        'BOOLEAN', 85, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isContactEscalatedToQueue',         'is_contact_escalated_to_queue',      'BOOLEAN', 86, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isContactHandled',                  'is_contact_handled',                 'BOOLEAN', 87, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isContactOffered',                  'is_contact_offered',                 'BOOLEAN', 88, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isEmailSent',                       'is_email_sent',                      'BOOLEAN', 89, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isHandledByPreferredAgent',         'is_handled_by_preferred_agent',      'BOOLEAN', 90, 1, 0, 1, GETUTCDATE());
...
INSERT INTO schema_config
    (source_name, source_table_name, target_table_name, source_column_name, target_column_name,
     target_data_type, ordinal_position, include_in_md5hash, is_primary_key, is_active, created_at)
VALUES
  ('Webex', 'csr', 'csr_base', 'isMonitored',                       'is_monitored',                       'BOOLEAN',  91, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isOptOutOfQueue',                   'is_opt_out_of_queue',                'BOOLEAN',  92, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isOutdial',                         'is_outdial',                         'BOOLEAN',  93, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isRealtimeTranscriptionEnabled',    'is_realtime_transcription_enabled',  'BOOLEAN',  94, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isRecordingDeleted',                'is_recording_deleted',               'BOOLEAN',  95, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isSuggestedResponseRequested',      'is_suggested_response_requested',    'BOOLEAN',  96, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isTranscriptionAvailable',          'is_transcription_available',         'BOOLEAN',  97, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isWithInServiceLevel',              'is_with_in_service_level',           'BOOLEAN',  98, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'ivrEndedCount',                     'ivr_ended_count',                    'INT',      99, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'ivrScriptId',                       'ivr_script_id',                      'STRING',  100, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'ivrScriptName',                     'ivr_script_name',                    'STRING',  101, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'ivrScriptTagId',                    'ivr_script_tag_id',                  'STRING',  102, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'ivrScriptTagName',                  'ivr_script_tag_name',                'STRING',  103, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastActivityTime',                  'last_activity_time',                 'BIGINT',  104, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastAgent',                         'last_agent_json',                    'STRING',  105, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastEntryPoint',                    'last_entry_point_json',              'STRING',  106, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastQueue',                         'last_queue_json',                    'STRING',  107, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastSite',                          'last_site_json',                     'STRING',  108, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastTeam',                          'last_team_json',                     'STRING',  109, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastWrapUpCodeId',                  'last_wrap_up_code_id',               'STRING',  110, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastWrapupCodeName',                'last_wrapup_code_name',              'STRING',  111, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'manualAssignCount',                 'manual_assign_count',                'INT',     112, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'matchedSkills',                     'matched_skills_json',                'STRING',  113, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'matchedSkillsProfile',              'matched_skills_profile',             'STRING',  114, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'midCallSummaryCount',               'mid_call_summary_count',             'INT',     115, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'midcallMonitoringCount',            'midcall_monitoring_count',           'INT',     116, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'monitorFullName',                   'monitor_full_name',                  'STRING',  117, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'monitoringTimestamp',               'monitoring_timestamp',               'BIGINT',  118, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'origin',                            'origin',                             'STRING',  119, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'outdialConsultCount',               'outdial_consult_count',              'INT',     120, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'outdialConsultToEPCount',           'outdial_consult_to_ep_count',        'INT',     121, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'outdialConsultToEPDuration',        'outdial_consult_to_ep_duration',     'INT',     122, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'outdialConsultToQueueCount',        'outdial_consult_to_queue_count',     'INT',     123, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'outdialConsultToQueueDuration',     'outdial_consult_to_queue_duration',  'INT',     124, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'outdialType',                       'outdial_type',                       'STRING',  125, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'overallEvalScore',                  'overall_eval_score',                 'STRING',  126, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'overflowCount',                     'overflow_count',                     'INT',     127, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'pausedCount',                       'paused_count',                       'INT',     128, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'pausedDuration',                    'paused_duration',                    'INT',     129, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'personalCallBackAgentName',         'personal_call_back_agent_name',      'STRING',  130, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'postCallConsultDuration',           'post_call_consult_duration',         'INT',     131, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'postCallDuration',                  'post_call_duration',                 'INT',     132, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'postCallSummaryCount',              'post_call_summary_count',            'INT',     133, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'preferredAgentName',                'preferred_agent_name',               'STRING',  134, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'preferredAgentSystemId',            'preferred_agent_system_id',          'STRING',  135, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'previousAgentId',                   'previous_agent_id',                  'STRING',  136, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'previousAgentName',                 'previous_agent_name',                'STRING',  137, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'previousAgentSessionId',            'previous_agent_session_id',          'STRING',  138, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'previousQueue',                     'previous_queue_json',                'STRING',  139, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'queueCount',                        'queue_count',                        'INT',     140, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'queueDuration',                     'queue_duration',                     'INT',     141, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'queueTransferToEPCount',            'queue_transfer_to_ep_count',         'INT',     142, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'queueTransferToQueueCount',         'queue_transfer_to_queue_count',      'INT',     143, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'recordingCount',                    'recording_count',                    'INT',     144, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'recordingErrorCount',               'recording_error_count',              'INT',     145, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'recordingFileSize',                 'recording_file_size',                'INT',     146, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'recordingLocation',                 'recording_location',                 'STRING',  147, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'recordingStereoBlobId',             'recording_stereo_blob_id',           'STRING',  148, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'requiredSkills',                    'required_skills_json',               'STRING',  149, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'resumedCount',                      'resumed_count',                      'INT',     150, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'ringingDuration',                   'ringing_duration',                   'INT',     151, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'routingType',                       'routing_type',                       'STRING',  152, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'selfserviceCount',                  'selfservice_count',                  'INT',     153, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'selfserviceDuration',               'selfservice_duration',               'INT',     154, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'shortInIVRCount',                   'short_in_ivr_count',                 'INT',     155, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'shortInQueueCount',                 'short_in_queue_count',               'INT',     156, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'silentMonitoringCount',             'silent_monitoring_count',            'INT',     157, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'skillsAssignedIn',                  'skills_assigned_in',                 'STRING',  158, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'status',                            'status',                             'STRING',  159, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'suddenDisconnectCount',             'sudden_disconnect_count',            'INT',     160, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'terminatingEnd',                    'terminating_end',                    'STRING',  161, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'terminationReason',                 'termination_reason',                 'STRING',  162, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'terminationType',                   'termination_type',                   'STRING',  163, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'topicName',                         'topic_name',                         'STRING',  164, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'totalBnrDuration',                  'total_bnr_duration',                 'INT',     165, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'totalDuration',                     'total_duration',                     'INT',     166, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'totalMonitoringCount',              'total_monitoring_count',             'INT',     167, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'transferCount',                     'transfer_count',                     'INT',     168, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'transferEpDN',                      'transfer_ep_dn',                     'STRING',  169, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'transferErrorCount',                'transfer_error_count',               'INT',     170, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'transferInToEPCount',               'transfer_in_to_ep_count',            'INT',     171, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'vaRecordingAvailable',              'va_recording_available',             'BOOLEAN', 172, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'vaTranscriptionAvailable',          'va_transcription_available',         'STRING',  173, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'wordRatioCount',                    'word_ratio_count',                   'INT',     174, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'wordRatioScore',                    'word_ratio_score',                   'STRING',  175, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'wrapupDuration',                    'wrapup_duration',                    'INT',     176, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', '__top__.start_date',                'start_date',                         'STRING',  177, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', '__top__.end_date',                  'end_date',                           'STRING',  178, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', '__top__.record_type',               'record_type',                        'STRING',  179, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', '__top__.source',                    'source',                             'STRING',  180, 0, 0, 1, GETUTCDATE());

-- Total Webex: 344 rows (AAR 13 + ASR 25 + CLR 107 + CAR 19 + CSR 180)