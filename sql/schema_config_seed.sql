...
-- [W01] aar — 13 data fields + 4 context
INSERT INTO schema_config
    (source_name, source_table_name, target_table_name, source_column_name, target_column_name,
     target_data_type, ordinal_position, include_in_md5hash, is_primary_key, is_active, created_at)
VALUES
  ('Webex', 'aar', 'aar_base', 'agentId',                       'agent_id',                       'STRING',  1, 1, 1, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'agentName',                     'agent_name',                     'STRING',  2, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'agentSessionId',                'agent_session_id',               'STRING',  3, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'siteId',                        'site_id',                        'STRING',  4, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'siteName',                      'site_name',                      'STRING',  5, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'teamId',                        'team_id',                        'STRING',  6, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'teamName',                      'team_name',                      'STRING',  7, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'userLoginId',                   'user_login_id',                  'STRING',  8, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'channelInfo.$0.channelId',      'channel_info_channel_id',        'STRING',  9, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'channelInfo.$0.channelType',    'channel_info_channel_type',      'STRING', 10, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'channelInfo.$0.subChannelType', 'channel_info_sub_channel_type',  'STRING', 11, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'channelInfo.$0.agentPhoneNumber','channel_info_agent_phone_number','STRING', 12, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'channelInfo.$0.activities',     'channel_info_activities_json',   'STRING', 13, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'N/A',                           'start_date',                     'STRING', 14, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'N/A',                           'end_date',                       'STRING', 15, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'N/A',                           'record_type',                    'STRING', 16, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'aar', 'aar_base', 'N/A',                           'source',                         'STRING', 17, 0, 0, 1, GETUTCDATE());

-- [W02] asr — 113 data fields + 4 context
INSERT INTO schema_config
    (source_name, source_table_name, target_table_name, source_column_name, target_column_name,
     target_data_type, ordinal_position, include_in_md5hash, is_primary_key, is_active, created_at)
VALUES
  ('Webex', 'asr', 'asr_base', 'agentId',                                              'agent_id',                                        'STRING',   1, 1, 1, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'agentName',                                            'agent_name',                                      'STRING',   2, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'agentSessionId',                                       'agent_session_id',                                'STRING',   3, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'agentSignOutReason',                                   'agent_sign_out_reason',                           'STRING',   4, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'endTime',                                              'end_time',                                        'BIGINT',   5, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'isActive',                                             'is_active',                                       'BOOLEAN',  6, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'multiMediaProfileType',                                'multi_media_profile_type',                        'STRING',   7, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'orgId',                                                'org_id',                                          'STRING',   8, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'orgName',                                              'org_name',                                        'STRING',   9, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'parentOrgId',                                          'parent_org_id',                                   'STRING',  10, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'parentOrgName',                                        'parent_org_name',                                 'STRING',  11, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'siteId',                                               'site_id',                                         'STRING',  12, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'siteName',                                             'site_name',                                       'STRING',  13, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'skillsProfile',                                        'skills_profile',                                  'STRING',  14, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'startTime',                                            'start_time',                                      'BIGINT',  15, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'state',                                                'state',                                           'STRING',  16, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'teamId',                                               'team_id',                                         'STRING',  17, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'teamName',                                             'team_name',                                       'STRING',  18, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'userLoginId',                                          'user_login_id',                                   'STRING',  19, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'agentSkills.$0.name',                                  'agent_skill_name',                                'STRING',  20, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'agentSkills.$0.intVal',                                'agent_skill_value',                               'INT',     21, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.agentPhoneNumber',                      'channel_agent_phone_number',                      'STRING',  22, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.channelId',                             'channel_id',                                      'STRING',  23, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.channelType',                           'channel_type',                                    'STRING',  24, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.subChannelType',                        'channel_sub_type',                                'STRING',  25, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.currentState',                          'channel_current_state',                           'STRING',  26, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.idleCodeName',                          'channel_idle_code_name',                          'STRING',  27, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.lastActivityTime',                      'channel_last_activity_time',                      'BIGINT',  28, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.totalDuration',                         'channel_total_duration',                          'INT',     29, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.totalReservationTime',                  'channel_total_reservation_time',                  'INT',     30, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.availableCount',                        'channel_available_count',                         'INT',     31, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.availableDuration',                     'channel_available_duration',                      'INT',     32, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.idleCount',                             'channel_idle_count',                              'INT',     33, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.idleDuration',                          'channel_idle_duration',                           'INT',     34, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.reservationCount',                      'channel_reservation_count',                       'INT',     35, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.connectedCount',                        'channel_connected_count',                         'INT',     36, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.connectedDuration',                     'channel_connected_duration',                      'INT',     37, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.ringingCount',                          'channel_ringing_count',                           'INT',     38, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.ringingDuration',                       'channel_ringing_duration',                        'INT',     39, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.holdCount',                             'channel_hold_count',                              'INT',     40, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.holdDuration',                          'channel_hold_duration',                           'INT',     41, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.wrapupCount',                           'channel_wrapup_count',                            'INT',     42, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.wrapupDuration',                        'channel_wrapup_duration',                         'INT',     43, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.postCallCount',                         'channel_post_call_count',                         'INT',     44, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.postCallDuration',                      'channel_post_call_duration',                      'INT',     45, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.postCallAssistanceCount',               'channel_post_call_assistance_count',              'INT',     46, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.postCallAssistanceDuration',            'channel_post_call_assistance_duration',           'INT',     47, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.notRespondedCount',                     'channel_not_responded_count',                     'INT',     48, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.notRespondedDuration',                  'channel_not_responded_duration',                  'INT',     49, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.manualAssignCount',                     'channel_manual_assign_count',                     'INT',     50, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.blindTransferCount',                    'channel_blind_transfer_count',                    'INT',     51, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.callBackCount',                         'channel_call_back_count',                         'INT',     52, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.transferCount',                         'channel_transfer_count',                          'INT',     53, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.conferenceCount',                       'channel_conference_count',                        'INT',     54, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.conferenceDuration',                    'channel_conference_duration',                     'INT',     55, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.conferenceTransferInCount',             'channel_conference_transfer_in_count',            'INT',     56, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultCount',                          'channel_consult_count',                           'INT',     57, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultDuration',                       'channel_consult_duration',                        'INT',     58, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultRequestCount',                   'channel_consult_request_count',                   'INT',     59, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultRequestDuration',                'channel_consult_request_duration',                'INT',     60, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultAnswerCount',                    'channel_consult_answer_count',                    'INT',     61, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultAnswerDuration',                 'channel_consult_answer_duration',                 'INT',     62, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultTransferInCount',                'channel_consult_transfer_in_count',               'INT',     63, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultToQueueCount',                   'channel_consult_to_queue_count',                  'INT',     64, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultToQueueDuration',                'channel_consult_to_queue_duration',               'INT',     65, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultToQueueRequestCount',            'channel_consult_to_queue_request_count',          'INT',     66, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultToQueueRequestDuration',         'channel_consult_to_queue_request_duration',       'INT',     67, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultToQueueAnswerCount',             'channel_consult_to_queue_answer_count',           'INT',     68, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultToQueueAnswerDuration',          'channel_consult_to_queue_answer_duration',        'INT',     69, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultToEpRequestedCount',             'channel_consult_to_ep_requested_count',           'INT',     70, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultToEpRequestedDuration',          'channel_consult_to_ep_requested_duration',        'INT',     71, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultToEpAnsweredCount',              'channel_consult_to_ep_answered_count',            'INT',     72, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.consultToEpAnsweredDuration',           'channel_consult_to_ep_answered_duration',         'INT',     73, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.disconnectedCount',                     'channel_disconnected_count',                      'INT',     74, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.disconnectedHoldCallsCount',            'channel_disconnected_hold_calls_count',           'INT',     75, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.agentToAgentTransferCount',             'channel_agent_to_agent_transfer_count',           'INT',     76, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.agentTransferToQueueRequestCount',      'channel_agent_transfer_to_queue_request_count',   'INT',     77, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialCount',                          'channel_outdial_count',                           'INT',     78, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConnectedCount',                 'channel_outdial_connected_count',                 'INT',     79, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConnectedDuration',              'channel_outdial_connected_duration',              'INT',     80, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialHoldCount',                      'channel_outdial_hold_count',                      'INT',     81, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialHoldDuration',                   'channel_outdial_hold_duration',                   'INT',     82, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialWrapupCount',                    'channel_outdial_wrapup_count',                    'INT',     83, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialWrapupDuration',                 'channel_outdial_wrapup_duration',                 'INT',     84, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialRingingCount',                   'channel_outdial_ringing_count',                   'INT',     85, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialRingingDuration',                'channel_outdial_ringing_duration',                'INT',     86, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialNotRespondedCount',              'channel_outdial_not_responded_count',             'INT',     87, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialNotRespondedDuration',           'channel_outdial_not_responded_duration',          'INT',     88, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialBlindTransferCount',             'channel_outdial_blind_transfer_count',            'INT',     89, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialTransferCount',                  'channel_outdial_transfer_count',                  'INT',     90, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConferenceCount',                'channel_outdial_conference_count',                'INT',     91, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConferenceDuration',             'channel_outdial_conference_duration',             'INT',     92, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialPostCallCount',                  'channel_outdial_post_call_count',                 'INT',     93, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialPostCallDuration',               'channel_outdial_post_call_duration',              'INT',     94, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialPostCallAssistanceCount',        'channel_outdial_post_call_assistance_count',      'INT',     95, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialPostCallAssistanceDuration',     'channel_outdial_post_call_assistance_duration',   'INT',     96, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConsultCount',                   'channel_outdial_consult_count',                   'INT',     97, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConsultDuration',                'channel_outdial_consult_duration',                'INT',     98, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConsultRequestCount',            'channel_outdial_consult_request_count',           'INT',     99, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConsultRequestDuration',         'channel_outdial_consult_request_duration',        'INT',    100, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConsultAnswerCount',             'channel_outdial_consult_answer_count',            'INT',    101, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConsultAnswerDuration',          'channel_outdial_consult_answer_duration',         'INT',    102, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConsultToQueueCount',            'channel_outdial_consult_to_queue_count',          'INT',    103, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConsultToQueueDuration',         'channel_outdial_consult_to_queue_duration',       'INT',    104, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConsultToQueueRequestCount',     'channel_outdial_consult_to_queue_request_count',  'INT',    105, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConsultToQueueRequestDuration',  'channel_outdial_consult_to_queue_request_duration','INT',   106, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConsultToEpRequestedCount',      'channel_outdial_consult_to_ep_requested_count',   'INT',    107, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConsultToEpRequestedDuration',   'channel_outdial_consult_to_ep_requested_duration','INT',    108, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConsultToEpAnsweredCount',       'channel_outdial_consult_to_ep_answered_count',    'INT',    109, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConsultToEpAnsweredDuration',    'channel_outdial_consult_to_ep_answered_duration', 'INT',    110, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialConsultTransferDuration',        'channel_outdial_consult_transfer_duration',       'INT',    111, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialAgentToAgentTransferCount',      'channel_outdial_agent_to_agent_transfer_count',   'INT',    112, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'channelInfo.$0.outdialAgentTransferToQueueRequestCount','channel_outdial_agent_transfer_to_queue_request_count','INT',113, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'N/A',                                                  'start_date',                                      'STRING', 114, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'N/A',                                                  'end_date',                                        'STRING', 115, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'N/A',                                                  'record_type',                                     'STRING', 116, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'asr', 'asr_base', 'N/A',                                                  'source',                                          'STRING', 117, 0, 0, 1, GETUTCDATE());

-- [W03] clr — 117 data fields + 4 context
INSERT INTO schema_config
    (source_name, source_table_name, target_table_name, source_column_name, target_column_name,
     target_data_type, ordinal_position, include_in_md5hash, is_primary_key, is_active, created_at)
VALUES
  ('Webex', 'clr', 'clr_base', 'id',                              'id',                                 'STRING',   1, 1, 1, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'taskId',                          'task_id',                            'STRING',   2, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'callLegType',                     'call_leg_type',                      'STRING',   3, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'channelType',                     'channel_type',                       'STRING',   4, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'channelSubType',                  'channel_sub_type',                   'STRING',   5, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'direction',                       'direction',                          'STRING',   6, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'origin',                          'origin',                             'STRING',   7, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'destination',                     'destination',                        'STRING',   8, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'contactState',                    'contact_state',                      'STRING',   9, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'status',                          'status',                             'STRING',  10, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'createdTime',                     'created_time',                       'BIGINT',  11, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'endedTime',                       'ended_time',                         'BIGINT',  12, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'lastActivityTime',                'last_activity_time',                 'BIGINT',  13, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'handleTime',                      'handle_time',                        'INT',     14, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'handleType',                      'handle_type',                        'STRING',  15, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'isActive',                        'is_active',                          'BOOLEAN', 16, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'isOutdial',                       'is_outdial',                         'BOOLEAN', 17, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'isOptOutOfQueue',                 'is_opt_out_of_queue',                'BOOLEAN', 18, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'isTaskLegHandled',                'is_task_leg_handled',                'BOOLEAN', 19, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'isWithinServiceLevel',            'is_within_service_level',            'BOOLEAN', 20, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'isHandledByPreferredAgent',       'is_handled_by_preferred_agent',      'BOOLEAN', 21, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'customer.email',                  'customer_email',                     'STRING',  22, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'customer.name',                   'customer_name',                      'STRING',  23, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'customer.phoneNumber',            'customer_phone_number',              'STRING',  24, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'entryPoint.id',                   'entry_point_id',                     'STRING',  25, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'entryPoint.name',                 'entry_point_name',                   'STRING',  26, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'owner.id',                        'owner_id',                           'STRING',  27, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'owner.name',                      'owner_name',                         'STRING',  28, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'owner.channelId',                 'owner_channel_id',                   'STRING',  29, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'owner.phoneNumber',               'owner_phone_number',                 'STRING',  30, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'owner.sessionId',                 'owner_session_id',                   'STRING',  31, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'owner.signInId',                  'owner_sign_in_id',                   'STRING',  32, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'queue.id',                        'queue_id',                           'STRING',  33, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'queue.name',                      'queue_name',                         'STRING',  34, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'queue.duration',                  'queue_duration',                     'INT',     35, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'site.id',                         'site_id',                            'STRING',  36, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'site.name',                       'site_name',                          'STRING',  37, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'team.id',                         'team_id',                            'STRING',  38, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'team.name',                       'team_name',                          'STRING',  39, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'nextDestination.agent',           'next_destination_agent',             'STRING',  40, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'nextDestination.queue',           'next_destination_queue',             'STRING',  41, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'nextDestination.team',            'next_destination_team',              'STRING',  42, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'queueCount',                      'queue_count',                        'INT',     43, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'queuedTo',                        'queued_to',                          'STRING',  44, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'optOutOfQueueTimestamp',          'opt_out_of_queue_timestamp',         'BIGINT',  45, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'holdCount',                       'hold_count',                         'INT',     46, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'holdDuration',                    'hold_duration',                      'INT',     47, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'connectedCount',                  'connected_count',                    'INT',     48, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'connectedDuration',               'connected_duration',                 'INT',     49, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'ringingDuration',                 'ringing_duration',                   'INT',     50, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'wrapupDuration',                  'wrapup_duration',                    'INT',     51, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'selfserviceCount',                'selfservice_count',                  'INT',     52, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'selfserviceDuration',             'selfservice_duration',               'INT',     53, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultDuration',                 'consult_duration',                   'INT',     54, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultSuccessCount',             'consult_success_count',              'INT',     55, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToAgentErrorCount',        'consult_to_agent_error_count',       'INT',     56, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToDnErrorCount',           'consult_to_dn_error_count',          'INT',     57, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToEPCount',                'consult_to_ep_count',                'INT',     58, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToEPDuration',             'consult_to_ep_duration',             'INT',     59, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToEpErrorCount',           'consult_to_ep_error_count',          'INT',     60, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToQueueCount',             'consult_to_queue_count',             'INT',     61, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToQueueDuration',          'consult_to_queue_duration',          'INT',     62, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToQueueErrorCount',        'consult_to_queue_error_count',       'INT',     63, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultToQueueHandledCount',      'consult_to_queue_handled_count',     'INT',     64, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'conferenceDuration',              'conference_duration',                'INT',     65, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'conferenceSuccessCount',          'conference_success_count',           'INT',     66, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'conferenceConnectedCount',        'conference_connected_count',         'STRING',  67, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'connectErrorCount',               'connect_error_count',                'INT',     68, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'transferCount',                   'transfer_count',                     'INT',     69, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'transferOutCount',                'transfer_out_count',                 'INT',     70, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'transferErrorCount',              'transfer_error_count',               'INT',     71, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'transferEpDN',                    'transfer_ep_dn',                     'STRING',  72, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'blindTransferCount',              'blind_transfer_count',               'INT',     73, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'blindTransferToAgentCount',       'blind_transfer_to_agent_count',      'INT',     74, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'agentToDnTransferCount',          'agent_to_dn_transfer_count',         'INT',     75, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'agentTransferedInCount',          'agent_transfered_in_count',          'INT',     76, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'interQueueBlindTransferCount',    'inter_queue_blind_transfer_count',   'INT',     77, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'interQueueConsultTransferCount',  'inter_queue_consult_transfer_count', 'INT',     78, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConferenceCount',          'outdial_conference_count',           'INT',     79, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConferenceDuration',       'outdial_conference_duration',        'INT',     80, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultCount',             'outdial_consult_count',              'INT',     81, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultDuration',          'outdial_consult_duration',           'INT',     82, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultToEPCount',         'outdial_consult_to_ep_count',        'INT',     83, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultToEPDuration',      'outdial_consult_to_ep_duration',     'INT',     84, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultToQueueCount',      'outdial_consult_to_queue_count',     'INT',     85, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultToQueueDuration',   'outdial_consult_to_queue_duration',  'INT',     86, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultToQueueErrorCount', 'outdial_consult_to_queue_error_count','INT',    87, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'outdialConsultToQueueHandledCount','outdial_consult_to_queue_handled_count','INT', 88, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'postCallConnectedCount',          'post_call_connected_count',          'STRING',  89, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'postCallConsultDuration',         'post_call_consult_duration',         'INT',     90, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'postCallDuration',                'post_call_duration',                 'INT',     91, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'ronaCount',                       'rona_count',                         'INT',     92, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'callRejectedCount',               'call_rejected_count',                'INT',     93, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'callType',                        'call_type',                          'STRING',  94, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'abandonedSlCount',                'abandoned_sl_count',                 'STRING',  95, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'abandonedType',                   'abandoned_type',                     'STRING',  96, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'slaValue',                        'sla_value',                          'STRING',  97, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'routingType',                     'routing_type',                       'STRING',  98, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'skillsAssignedIn',                'skills_assigned_in',                 'STRING',  99, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'matchedSkills',                   'matched_skills',                     'STRING', 100, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'matchedSkillsProfile',            'matched_skills_profile',             'STRING', 101, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'requiredSkills',                  'required_skills',                    'STRING', 102, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'preferredAgentName',              'preferred_agent_name',               'STRING', 103, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'preferredAgentSystemId',          'preferred_agent_system_id',          'STRING', 104, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'childContactId',                  'child_contact_id',                   'STRING', 105, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'childContactType',                'child_contact_type',                 'STRING', 106, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultEpId',                     'consult_ep_id',                      'STRING', 107, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'consultEpName',                   'consult_ep_name',                    'STRING', 108, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'taskLegCount',                    'task_leg_count',                     'INT',    109, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'manualAssignCount',               'manual_assign_count',                'INT',    110, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'ivrScriptId',                     'ivr_script_id',                      'STRING', 111, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'ivrScriptName',                   'ivr_script_name',                    'STRING', 112, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'ivrScriptTagId',                  'ivr_script_tag_id',                  'STRING', 113, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'ivrScriptTagName',                'ivr_script_tag_name',                'STRING', 114, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'lastWrapupCodeName',              'last_wrapup_code_name',              'STRING', 115, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'terminatingEnd',                  'terminating_end',                    'STRING', 116, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'terminationReason',               'termination_reason',                 'STRING', 117, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'N/A',                             'start_date',                         'STRING', 118, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'N/A',                             'end_date',                           'STRING', 119, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'N/A',                             'record_type',                        'STRING', 120, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'clr', 'clr_base', 'N/A',                             'source',                             'STRING', 121, 0, 0, 1, GETUTCDATE());

-- [W04] car — 15 data fields + 4 context
INSERT INTO schema_config
    (source_name, source_table_name, target_table_name, source_column_name, target_column_name,
     target_data_type, ordinal_position, include_in_md5hash, is_primary_key, is_active, created_at)
VALUES
  ('Webex', 'car', 'car_base', 'id',                   'id',                    'STRING',   1, 1, 1, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'channelType',           'channel_type',          'STRING',   2, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'channelSubType',        'channel_sub_type',      'STRING',   3, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'destination',           'destination',           'STRING',   4, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'origin',                'origin',                'STRING',   5, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'isOutdial',             'is_outdial',            'BOOLEAN',  6, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'isEmailSent',           'is_email_sent',         'BOOLEAN',  7, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'emailToList',           'email_to_list',         'STRING',   8, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'emailCcList',           'email_cc_list',         'STRING',   9, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'emailBccList',          'email_bcc_list',        'STRING',  10, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'emailReplyTo',          'email_reply_to',        'STRING',  11, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'matchedSkillsProfile',  'matched_skills_profile','STRING',  12, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'preferredAgentName',    'preferred_agent_name',  'STRING',  13, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'routingType',           'routing_type',          'STRING',  14, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'activities.nodes',      'activity_nodes_json',   'STRING',  15, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'N/A',                   'start_date',            'STRING',  16, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'N/A',                   'end_date',              'STRING',  17, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'N/A',                   'record_type',           'STRING',  18, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'car', 'car_base', 'N/A',                   'source',                'STRING',  19, 0, 0, 1, GETUTCDATE());

-- [W05] csr — 207 data fields + 4 context  [part 1 of 3: ordinals 1-90]
INSERT INTO schema_config
    (source_name, source_table_name, target_table_name, source_column_name, target_column_name,
     target_data_type, ordinal_position, include_in_md5hash, is_primary_key, is_active, created_at)
VALUES
  ('Webex', 'csr', 'csr_base', 'id',                                'id',                                 'STRING',   1, 1, 1, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'channelType',                       'channel_type',                       'STRING',   2, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'channelSubType',                    'channel_sub_type',                   'STRING',   3, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'direction',                         'direction',                          'STRING',   4, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'origin',                            'origin',                             'STRING',   5, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'destination',                       'destination',                        'STRING',   6, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'status',                            'status',                             'STRING',   7, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'createdTime',                       'created_time',                       'BIGINT',   8, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'endedTime',                         'ended_time',                         'BIGINT',   9, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastActivityTime',                  'last_activity_time',                 'BIGINT',  10, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'totalDuration',                     'total_duration',                     'INT',     11, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isActive',                          'is_active',                          'BOOLEAN', 12, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isOutdial',                         'is_outdial',                         'BOOLEAN', 13, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isCallback',                        'is_callback',                        'BOOLEAN', 14, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isCampaign',                        'is_campaign',                        'BOOLEAN', 15, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isBarged',                          'is_barged',                          'BOOLEAN', 16, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isMonitored',                       'is_monitored',                       'BOOLEAN', 17, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isContactHandled',                  'is_contact_handled',                 'BOOLEAN', 18, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isContactOffered',                  'is_contact_offered',                 'BOOLEAN', 19, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isContactEscalatedToQueue',         'is_contact_escalated_to_queue',      'BOOLEAN', 20, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isOptOutOfQueue',                   'is_opt_out_of_queue',                'BOOLEAN', 21, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isHandledByPreferredAgent',         'is_handled_by_preferred_agent',      'BOOLEAN', 22, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isWithInServiceLevel',              'is_with_in_service_level',           'BOOLEAN', 23, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isEmailSent',                       'is_email_sent',                      'BOOLEAN', 24, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isRecordingDeleted',                'is_recording_deleted',               'BOOLEAN', 25, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isRealtimeTranscriptionEnabled',    'is_realtime_transcription_enabled',  'BOOLEAN', 26, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isTranscriptionAvailable',          'is_transcription_available',         'BOOLEAN', 27, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'isSuggestedResponseRequested',      'is_suggested_response_requested',    'BOOLEAN', 28, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'captureRequested',                  'capture_requested',                  'BOOLEAN', 29, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'customer.email',                    'customer_email',                     'STRING',  30, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'customer.name',                      'customer_name',                      'STRING',  31, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'customer.phoneNumber',              'customer_phone_number',              'STRING',  32, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastAgent.id',                      'last_agent_id',                      'STRING',  33, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastAgent.name',                    'last_agent_name',                    'STRING',  34, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastAgent.channelId',               'last_agent_channel_id',              'STRING',  35, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastAgent.phoneNumber',             'last_agent_phone_number',            'STRING',  36, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastAgent.sessionId',               'last_agent_session_id',              'STRING',  37, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastAgent.signInId',                'last_agent_sign_in_id',              'STRING',  38, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastEntryPoint.id',                 'last_entry_point_id',                'STRING',  39, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastEntryPoint.name',               'last_entry_point_name',              'STRING',  40, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastQueue.id',                      'last_queue_id',                      'STRING',  41, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastQueue.name',                    'last_queue_name',                    'STRING',  42, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastQueue.duration',                'last_queue_duration',                'INT',     43, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastSite.id',                       'last_site_id',                       'STRING',  44, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastSite.name',                     'last_site_name',                     'STRING',  45, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastTeam.id',                       'last_team_id',                       'STRING',  46, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastTeam.name',                     'last_team_name',                     'STRING',  47, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'previousQueue.id',                  'previous_queue_id',                  'STRING',  48, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'previousQueue.name',                'previous_queue_name',                'STRING',  49, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'callbackData.callbackAgentName',    'callback_agent_name',                'STRING',  50, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'callbackData.callbackConnectTime',  'callback_connect_time',              'BIGINT',  51, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'callbackData.callbackNumber',       'callback_number',                    'STRING',  52, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'callbackData.callbackOrigin',       'callback_origin',                    'STRING',  53, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'callbackData.callbackQueueName',    'callback_queue_name',                'STRING',  54, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'callbackData.callbackRequestTime',  'callback_request_time',              'BIGINT',  55, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'callbackData.callbackRetryCount',   'callback_retry_count',               'INT',     56, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'callbackData.callbackStatus',       'callback_status',                    'STRING',  57, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'callbackData.callbackTeamName',     'callback_team_name',                 'STRING',  58, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'callbackData.callbackType',         'callback_type',                      'STRING',  59, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'channelMetaData.chat',              'channel_meta_chat',                  'STRING',  60, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'channelMetaData.email',             'channel_meta_email',                 'STRING',  61, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'channelMetaData.inBoundTranscript', 'channel_meta_inbound_transcript',    'STRING',  62, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'channelMetaData.outBoundTranscript','channel_meta_outbound_transcript',   'STRING',  63, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'feedback.comment',                  'feedback_comment',                   'STRING',  64, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'feedback.questionsAnswered',        'feedback_questions_answered',        'INT',     65, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'feedback.questionsPresented',       'feedback_questions_presented',       'INT',     66, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'feedback.surveyCompleted',          'feedback_survey_completed',          'BOOLEAN', 67, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'feedback.surveyOptIn',              'feedback_survey_opt_in',             'STRING',  68, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'feedback.type',                     'feedback_type',                      'STRING',  69, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'matchedSkills.$0.name',             'matched_skill_name',                 'STRING',  70, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'matchedSkills.$0.intVal',           'matched_skill_value',                'INT',     71, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'requiredSkills.$0.operand',         'required_skill_operand',             'STRING',  72, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'requiredSkills.$0.name',            'required_skill_name',                'STRING',  73, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'requiredSkills.$0.intVal',          'required_skill_value',               'INT',     74, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'firstQueueId',                      'first_queue_id',                     'STRING',  75, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'firstQueueName',                    'first_queue_name',                   'STRING',  76, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'contactHandleType',                 'contact_handle_type',                'STRING',  77, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'contactPriority',                   'contact_priority',                   'INT',     78, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'contactReason',                     'contact_reason',                     'STRING',  79, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'contactDriver',                     'contact_driver',                     'STRING',  80, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'routingType',                       'routing_type',                       'STRING',  81, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'skillsAssignedIn',                  'skills_assigned_in',                 'STRING',  82, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'matchedSkillsProfile',              'matched_skills_profile',             'STRING',  83, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'connectedCount',                    'connected_count',                    'INT',     84, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'connectedDuration',                 'connected_duration',                 'INT',     85, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'holdCount',                         'hold_count',                         'INT',     86, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'holdDuration',                      'hold_duration',                      'INT',     87, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'wrapupDuration',                    'wrapup_duration',                    'INT',     88, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'queueCount',                        'queue_count',                        'INT',     89, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'queueDuration',                     'queue_duration',                     'INT',     90, 1, 0, 1, GETUTCDATE());

-- [W05] csr — 207 data fields + 4 context  [part 2 of 3: ordinals 91-180]
INSERT INTO schema_config
    (source_name, source_table_name, target_table_name, source_column_name, target_column_name,
     target_data_type, ordinal_position, include_in_md5hash, is_primary_key, is_active, created_at)
VALUES
  ('Webex', 'csr', 'csr_base', 'ringingDuration',                   'ringing_duration',                   'INT',     91, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'selfserviceCount',                  'selfservice_count',                  'INT',     92, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'selfserviceDuration',               'selfservice_duration',               'INT',     93, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'consultCount',                      'consult_count',                      'INT',     94, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'consultDuration',                   'consult_duration',                   'INT',     95, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'consultToEPCount',                  'consult_to_ep_count',                'INT',     96, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'consultToEPDuration',               'consult_to_ep_duration',             'INT',     97, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'consultToQueueCount',               'consult_to_queue_count',             'INT',     98, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'consultToQueueDuration',            'consult_to_queue_duration',          'INT',     99, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'conferenceCount',                   'conference_count',                   'INT',    100, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'conferenceDuration',                'conference_duration',                'INT',    101, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'blindTransferCount',                'blind_transfer_count',               'INT',    102, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'transferCount',                     'transfer_count',                     'INT',    103, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'transferErrorCount',                'transfer_error_count',               'INT',    104, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'transferEpDN',                      'transfer_ep_dn',                     'STRING', 105, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'transferInToEPCount',               'transfer_in_to_ep_count',            'INT',    106, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'agentToDnTransferCount',            'agent_to_dn_transfer_count',         'INT',    107, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'agentToQueueTransferCount',         'agent_to_queue_transfer_count',      'INT',    108, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'agentToEntrypointTransferCount',    'agent_to_entrypoint_transfer_count', 'INT',    109, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'agentTransferedInCount',            'agent_transfered_in_count',          'INT',    110, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'agentToAgentTransferCount',         'agent_to_agent_transfer_count',      'STRING', 111, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'queueTransferToEPCount',            'queue_transfer_to_ep_count',         'INT',    112, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'queueTransferToQueueCount',         'queue_transfer_to_queue_count',      'INT',    113, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'epTransferToEPCount',               'ep_transfer_to_ep_count',            'INT',    114, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'chainedInToEPCount',                'chained_in_to_ep_count',             'INT',    115, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'chainedInToQueueCount',             'chained_in_to_queue_count',          'INT',    116, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'outdialConsultCount',               'outdial_consult_count',              'INT',    117, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'outdialConsultToEPCount',           'outdial_consult_to_ep_count',        'INT',    118, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'outdialConsultToEPDuration',        'outdial_consult_to_ep_duration',     'INT',    119, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'outdialConsultToQueueCount',        'outdial_consult_to_queue_count',     'INT',    120, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'outdialConsultToQueueDuration',     'outdial_consult_to_queue_duration',  'INT',    121, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'overflowCount',                     'overflow_count',                     'INT',    122, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'bargedInCount',                     'barged_in_count',                    'INT',    123, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'bargedInDuration',                  'barged_in_duration',                 'INT',    124, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'bargedInFailedCount',               'barged_in_failed_count',             'INT',    125, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'fullMonitoringCount',               'full_monitoring_count',              'INT',    126, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'silentMonitoringCount',             'silent_monitoring_count',            'INT',    127, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'midcallMonitoringCount',            'midcall_monitoring_count',           'INT',    128, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'totalMonitoringCount',              'total_monitoring_count',             'INT',    129, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'monitoringTimestamp',               'monitoring_timestamp',               'BIGINT', 130, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'monitorFullName',                   'monitor_full_name',                  'STRING', 131, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'pausedCount',                       'paused_count',                       'INT',    132, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'pausedDuration',                    'paused_duration',                    'INT',    133, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'resumedCount',                      'resumed_count',                      'INT',    134, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'deadAirCount',                      'dead_air_count',                     'INT',    135, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'deadAirTime',                       'dead_air_time',                      'INT',    136, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'crossTalkCount',                    'cross_talk_count',                   'INT',    137, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'crossTalkTime',                     'cross_talk_time',                    'INT',    138, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'totalBnrDuration',                  'total_bnr_duration',                 'INT',    139, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'shortInIVRCount',                   'short_in_ivr_count',                 'INT',    140, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'shortInQueueCount',                 'short_in_queue_count',               'INT',    141, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'midCallSummaryCount',               'mid_call_summary_count',             'INT',    142, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'postCallSummaryCount',              'post_call_summary_count',            'INT',    143, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'postCallConsultDuration',           'post_call_consult_duration',         'INT',    144, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'postCallDuration',                  'post_call_duration',                 'INT',    145, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'recordingCount',                    'recording_count',                    'INT',    146, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'recordingErrorCount',               'recording_error_count',              'INT',    147, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'recordingFileSize',                 'recording_file_size',                'INT',    148, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'recordingLocation',                 'recording_location',                 'STRING', 149, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'recordingStereoBlobId',             'recording_stereo_blob_id',           'STRING', 150, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'vaRecordingAvailable',              'va_recording_available',             'BOOLEAN',151, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'vaTranscriptionAvailable',          'va_transcription_available',         'STRING', 152, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'csatScore',                         'csat_score',                         'INT',    153, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'autoCsat',                          'auto_csat',                          'STRING', 154, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'customerSentimentScore',            'customer_sentiment_score',           'STRING', 155, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'evalScore',                         'eval_score',                         'STRING', 156, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'evalScoreType',                     'eval_score_type',                    'STRING', 157, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'evalSectionsFailureCount',          'eval_sections_failure_count',        'INT',    158, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'evalStatus',                        'eval_status',                        'STRING', 159, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'overallEvalScore',                  'overall_eval_score',                 'STRING', 160, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'wordRatioCount',                    'word_ratio_count',                   'INT',    161, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'wordRatioScore',                    'word_ratio_score',                   'STRING', 162, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'suddenDisconnectCount',             'sudden_disconnect_count',            'INT',    163, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'terminatingEnd',                    'terminating_end',                    'STRING', 164, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'terminationReason',                 'termination_reason',                 'STRING', 165, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'terminationType',                   'termination_type',                   'STRING', 166, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'flowActivityName',                  'flow_activity_name',                 'STRING', 167, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'flowActivitySequence',              'flow_activity_sequence',             'STRING', 168, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'ivrScriptId',                       'ivr_script_id',                      'STRING', 169, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'ivrScriptName',                     'ivr_script_name',                    'STRING', 170, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'ivrScriptTagId',                    'ivr_script_tag_id',                  'STRING', 171, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'ivrScriptTagName',                  'ivr_script_tag_name',                'STRING', 172, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'ivrEndedCount',                     'ivr_ended_count',                    'INT',    173, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'campaignId',                        'campaign_id',                        'STRING', 174, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'campaignName',                      'campaign_name',                      'STRING', 175, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'campaignStatus',                    'campaign_status',                    'STRING', 176, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'cpaStatus',                         'cpa_status',                         'STRING', 177, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'botName',                           'bot_name',                           'STRING', 178, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'chatType',                          'chat_type',                          'STRING', 179, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'outdialType',                       'outdial_type',                       'STRING', 180, 1, 0, 1, GETUTCDATE());

-- [W05] csr — 207 data fields + 4 context  [part 3 of 3: ordinals 181-211]
INSERT INTO schema_config
    (source_name, source_table_name, target_table_name, source_column_name, target_column_name,
     target_data_type, ordinal_position, include_in_md5hash, is_primary_key, is_active, created_at)
VALUES
  ('Webex', 'csr', 'csr_base', 'agentHangupCount',                  'agent_hangup_count',                 'INT',    181, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'callCompletedCount',                'call_completed_count',               'INT',    182, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastWrapUpCodeId',                  'last_wrap_up_code_id',               'STRING', 183, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'lastWrapupCodeName',                'last_wrapup_code_name',              'STRING', 184, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'manualAssignCount',                 'manual_assign_count',                'INT',    185, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'previousAgentId',                   'previous_agent_id',                  'STRING', 186, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'previousAgentName',                 'previous_agent_name',                'STRING', 187, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'previousAgentSessionId',            'previous_agent_session_id',          'STRING', 188, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'preferredAgentName',                'preferred_agent_name',               'STRING', 189, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'preferredAgentSystemId',            'preferred_agent_system_id',          'STRING', 190, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'personalCallBackAgentName',         'personal_call_back_agent_name',      'STRING', 191, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailHasAttachments',               'email_has_attachments',              'BOOLEAN',192, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailDate',                         'email_date',                         'INT',    193, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailBccList',                      'email_bcc_list',                     'STRING', 194, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailCcList',                       'email_cc_list',                      'STRING', 195, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailReplyTo',                      'email_reply_to',                     'STRING', 196, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailToList',                       'email_to_list',                      'STRING', 197, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailMessageId',                    'email_message_id',                   'STRING', 198, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailRef',                          'email_ref',                          'STRING', 199, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailBody',                         'email_body',                         'STRING', 200, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailFullMessage',                  'email_full_message',                 'STRING', 201, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailReplyBody',                    'email_reply_body',                   'STRING', 202, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailContent',                      'email_content',                      'STRING', 203, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailContentType',                  'email_content_type',                 'STRING', 204, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'emailReplyContentType',             'email_reply_content_type',           'STRING', 205, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'topicName',                         'topic_name',                         'STRING', 206, 1, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'globalVariables',                   'global_variables_json',              'STRING', 207, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'N/A',                               'start_date',                         'STRING', 208, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'N/A',                               'end_date',                           'STRING', 209, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'N/A',                               'record_type',                        'STRING', 210, 0, 0, 1, GETUTCDATE()),
  ('Webex', 'csr', 'csr_base', 'N/A',                               'source',                             'STRING', 211, 0, 0, 1, GETUTCDATE());

-- Total Webex: 485 rows (AAR 17 + ASR 117 + CLR 121 + CAR 19 + CSR 211)